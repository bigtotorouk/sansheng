...
//			extraStr = json.getString("caozuokey");
//		} catch (JSONException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//			return;
...
//
//		CommonActivity.action = opration.getOpra();
//		CommonActivity.id = opration.getNumber();
//		bundle.putString(CommonApplication.BUNDEL_ID, opration.getNumber());
//		bundle.putString(CommonApplication.BUNDLE_TYPE, opration.getOpra());
...
//		// IndexActivity.action = IndexActivity.ACTION_PRODUCT;
//		// aIntent.setAction(IndexActivity.ACTION_PRODUCT);
//		// aIntent.putExtra(PushConstants.EXTRA_NOTIFICATION_CONTENT, content);
//		// aIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//		// aIntent.addFlags(Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED);
//		// }
...
//		// IndexActivity.action = IndexActivity.ACTION_NEWS;
//		// aIntent = new Intent(context, IndexActivity.class);
//		// IndexActivity.action = IndexActivity.ACTION_NEWS;
//		// aIntent.setAction(IndexActivity.ACTION_NEWS);
//		//
//		// bundle.putString(CommonApplication.BUNDEL_ID, opration.getNumber());
//		// bundle.putString(CommonApplication.BUNDLE_TYPE, opration.getOpra());
//		// aIntent.putExtras(bundle);
...
//		// IndexActivity.action = IndexActivity.ACTION_APP;
//		// aIntent = new Intent(context, IndexActivity.class);
//		// IndexActivity.action = IndexActivity.ACTION_APP;
//		// aIntent.setAction(IndexActivity.ACTION_APP);
...
//		Intent intent = new Intent(CommonActivity.ACTION_PUSH);
//
//		intent.putExtra(PushConstants.EXTRA_NOTIFICATION_CONTENT, content);
