...
public class WheelView extends View {
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFaeaeae;
	...
	private static final int ADDITIONAL_ITEMS_SPACE = 100;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(TEXT_SIZE * scale + 0.5f);
		}
		...
		if (valuePaint == null) {
			...
			final float scale = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(TEXT_SIZE * scale + 0.5f);
			// valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.piker_mask_item_);
		}
