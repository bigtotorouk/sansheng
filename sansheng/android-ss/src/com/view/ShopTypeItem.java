...
public class ShopTypeItem extends RelativeLayout {
	...
	public ShopTypeItem(Context context, AttributeSet attrs) {
		super(context, attrs);
		LayoutInflater layoutInflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		view = (View) layoutInflater.inflate(R.layout.layout_shop_item, null);
		initWidget();
		addView(view);
	...
	public void initWidget() {
		...
		imgRadio = (ImageView) view.findViewById(R.id.img_radio);
	}
	...
	public void selected() {
		imgRadio.setBackgroundResource(R.drawable.radio_selected);
	}

	public void unselected() {
		imgRadio.setBackgroundResource(R.drawable.radio_unselected);
